...
function About({ card }) {
  return (
    <section className="about">
      {card.burialPlace !== "Сочи" && (
        <>
          <p className="about__text">
            <strong>Годы жизни:</strong> {card.years}
          </p>
          <p className="about__text">
            <strong>Место рождения:</strong> {card.birthPlace}
          </p>
          <p className="about__text">
            <strong>Место службы:</strong> {card.dutyStation}
          </p>
          <p className="about__text">
            <strong>Место захронения:</strong> {card.burialPlace}
          </p>
        </>
      )}
      {card.facts.map((fact) => (
